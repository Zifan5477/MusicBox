...
.STYLE11 {font-size: 24px; font-family: "Times New Roman", Times, serif; color: #996699; }
-->
</style>
  </head>
				...
				<div class="row-3">
				  <form action="" method="post" id="search-form">
						...
						<table width="565" height="120" border="0">
                          <tr>
                            <th scope="row"><p class="STYLE11">Error!</p>
                            <p class="STYLE10">Please check your input information ~  </p></th>
                          </tr>
                        </table>
